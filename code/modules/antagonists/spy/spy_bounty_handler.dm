...
/datum/spy_bounty_handler/proc/try_add_to_loot_pool(datum/uplink_item/item)
	/**
	 * This is where we restrict what items can be obtained at all
	 * So far, anything that excludes uplink spy,
	 * anything from clown/nukeops,
